...
async function getProfile(username: string): Promise<AcademicProfile | null> {
  try {
    const response = await fetch(
      `${process.env.NEXT_PUBLIC_URL || 'http://localhost:3000'}/api/profile/${username}`,
      {
        cache: 'no-store',
      }
    );
        ...
        publications: [
          {
            ...
            citationCount: 45,
            abstract:
              'We present novel machine learning approaches for analyzing large-scale genomic datasets...',
          },
          {
            id: '2',
        ...
        education: [
          {
            ...
            endYear: 2020,
            description:
              'Thesis: Machine Learning for Biological Sequence Analysis',
          },
          {
            id: '2',
        ...
        awards: [
          {
            ...
            amount: '$500,000',
            description:
              'For contributions to computational biology and machine learning',
          },
        ],
        grants: [
          {
...
export async function generateMetadata({
  ...
  return {
    ...
    description:
      profile.bio ||
      `Academic profile of ${profile.firstName} ${profile.lastName}`,
    openGraph: {
