...
```css
--sage-green: #8fa68e /* Primary brand color */ --warm-beige: #f5f2e8
  /* Background warmth */ --soft-blue: #6b8cae /* Academic trust */
  --charcoal: #2f3437 /* Primary text */ --light-gray: #f8f9fa
  /* Card backgrounds */ /* Academic Metrics */ --citation-orange: #e67e22
  --collaboration-blue: #3498db --grant-gold: #f39c12
  --publication-green: #27ae60 --teaching-purple: #9b59b6;
```
